        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="AdminServlet.do?id=<%= classroom.getId() %>&op=cEditBtn" class="btn c_edit-btn">Edit</a>
                        <a href="AdminServlet.do?id=<%= classroom.getId() %>&op=cDeleteBtn" class="btn c_delete-btn" onclick="return confirm('Are you sure you want to delete this classroom?');">Delete</a>
                    </td>
                </tr>
                <%
                        }
